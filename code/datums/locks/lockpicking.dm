...
/obj/proc/picked(mob/living/user, obj/lockpick_used, skill_level, difficulty)
	...
	if(prob(break_prob))
		...
		playsound(src, 'modular/kaizoku/sound/items/LPBreak.ogg', min(100 - (15 * skill_level) + (10 * 6 - difficulty), 100), extrarange = SILENCED_SOUND_EXTRARANGE)
		qdel(lockpick_used)
	...
	playsound(src, 'modular/kaizoku/sound/items/LPWin.ogg', min(100 - (15 * skill_level) + (10 * 6 - difficulty), 100), extrarange = SILENCED_SOUND_EXTRARANGE)
...
/client/proc/spawn_lockpicking_UI(obj/lock, mob/living/user, obj/lockpick, obj/wedge, difficulty, shown_d, skill_level) //potentially different sprites for locks and picks, put here
	...
	playsound(user, 'modular/kaizoku/sound/items/LPstart.ogg', min(100 - (15 * skill_level) + (10 * 6 - difficulty), 100), extrarange = SILENCED_SOUND_EXTRARANGE)
...
/atom/movable/screen/movable/snap/lockpicking/process()
	...
	if(failing)
		...
		lock_angle -= 20
		playsound(picker, pick('modular/kaizoku/sound/items/LPtry.ogg', 'modular/kaizoku/sound/items/LPtry2.ogg'), min(100 - (15 * skill_level) + (10 * 6 - difficulty), 100), extrarange = SILENCED_SOUND_EXTRARANGE)
...
/atom/movable/screen/movable/snap/lockpicking/proc/play_turn_sound(timerd)
	//playsound(picker, pick('modular/kaizoku/sound/items/LPTurn1.ogg', 'modular/kaizoku/sound/items/LPTurn2.ogg'), (100 - (15 * skill_level)) * 0.5)
