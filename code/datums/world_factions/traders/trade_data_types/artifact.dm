...
/datum/trader_data/artifact_weapons
	...
	custom_items = list(
		...
		// /obj/item/gun/ballistic/revolver/grenadelauncher/bow/turbulenta = list(1, PRICE_GOD_ARTIFACT, 1), //Stonekeep Edit: Kaizoku. We don't have Baotha here, so I removed this item.
