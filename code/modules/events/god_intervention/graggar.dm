...
/datum/round_event/graggar_culling/start()
	...
	for(var/i in 1 to max_pairs)
		...
		first_chosen.playsound_local(first_chosen, 'modular/kaizoku/sound/misc/gods/graggar_omen.ogg', 100)
		...
		second_chosen.playsound_local(second_chosen, 'modular/kaizoku/sound/misc/gods/graggar_omen.ogg', 100)
