/datum/job/advclass/pilgrim/briar
	...
	cmode_music = 'modular/kaizoku/sound/music/cmode/garrison/CombatForestGarrison.ogg'
...
/obj/item/dendor_blessing/proc/give_blessing(mob/living/carbon/human/user)
	playsound(user, 'modular/kaizoku/sound/vo/smokedrag.ogg', 100, TRUE)
	playsound(user, 'modular/kaizoku/sound/misc/wind.ogg', 100, TRUE, -1)
	user.emote("smile")
...
/obj/item/dendor_blessing/devouring/give_blessing(mob/living/user)
	...
	user.emote("pain")
	sleep(0.5 SECONDS)
	playsound(user, 'modular/kaizoku/sound/combat/fracture/fracturewet (1).ogg', 70, TRUE, -1)
	user.Immobilize(30)
	sleep(3.5 SECONDS)
