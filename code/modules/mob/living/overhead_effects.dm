...
/mob/living/carbon/proc/play_stress_indicator()
	play_overhead_indicator('icons/mob/overhead_effects.dmi', "stress", 20, OBJ_LAYER, soundin = 'modular/kaizoku/sound/ddstress.ogg')

/mob/living/carbon/proc/play_relief_indicator()
	play_overhead_indicator('icons/mob/overhead_effects.dmi', "relief", 20, OBJ_LAYER, soundin = 'modular/kaizoku/sound/ddrelief.ogg')

/mob/living/carbon/proc/play_mental_break_indicator()
	play_overhead_indicator('icons/mob/overhead_effects.dmi', "mentalbreak", 30, OBJ_LAYER, soundin = 'modular/kaizoku/sound/stressaffliction.ogg')
