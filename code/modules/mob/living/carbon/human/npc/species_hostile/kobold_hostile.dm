/mob/living/carbon/human/species/kobold/base
...
/mob/living/carbon/human/species/kobold/base/Initialize()
	. = ..()
...
/mob/living/carbon/human/species/kobold/base/very_skilled
	dodgetime = 30
	flee_in_pain = FALSE

/mob/living/carbon/human/species/kobold/base/very_skilled/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_CRITICAL_RESISTANCE, TRAIT_GENERIC)

/mob/living/carbon/human/species/kobold/base/skilled
	dodgetime = 40
	flee_in_pain = FALSE

/mob/living/carbon/human/species/kobold/base/unskilled
	dodgetime = 60

/mob/living/carbon/human/species/kobold/base/unskilled/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_CRITICAL_WEAKNESS, TRAIT_GENERIC)

// --- Naked ---

/mob/living/carbon/human/species/kobold/base/unskilled/naked
	base_strength = 8
	base_speed = 14
...
/mob/living/carbon/human/species/kobold/base/unskilled/naked/after_creation()
	..()
...
/mob/living/carbon/human/species/kobold/base/skilled/naked
	base_strength = 10
	base_speed = 14
	base_constitution = 12
	base_endurance = 12
...
/mob/living/carbon/human/species/kobold/base/skilled/naked/after_creation()
	..()
...
/mob/living/carbon/human/species/kobold/base/very_skilled/naked
	base_strength = 13
	base_speed = 14
	base_perception = 12
...
/mob/living/carbon/human/species/kobold/base/very_skilled/naked/after_creation()
	..()
...
/mob/living/carbon/human/species/kobold/base/unskilled/light_gear
	base_strength = 10
	base_speed = 12
	base_perception = 12
	base_constitution = 10
...
/mob/living/carbon/human/species/kobold/base/unskilled/light_gear/after_creation()
	..()
...
/mob/living/carbon/human/species/kobold/base/skilled/light_gear
	base_strength = 10
	base_speed = 13
	base_perception = 14
	base_constitution = 10
...
/mob/living/carbon/human/species/kobold/base/skilled/light_gear/after_creation()
	..()
...
/mob/living/carbon/human/species/kobold/base/very_skilled/light_gear
	base_strength = 11
	base_speed = 14
	base_perception = 15
	base_constitution = 10
...
/mob/living/carbon/human/species/kobold/base/very_skilled/light_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_DUALWIELDER, TRAIT_GENERIC)
	ADD_TRAIT(src, TRAIT_DODGEEXPERT, TRAIT_GENERIC)
	ADD_TRAIT(src, TRAIT_LIGHT_STEP, TRAIT_GENERIC)
...
/mob/living/carbon/human/species/kobold/base/unskilled/medium_gear
	base_strength = 11
	base_speed = 10
	base_perception = 9
	base_constitution = 12
...
/mob/living/carbon/human/species/kobold/base/unskilled/medium_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_MEDIUMARMOR, TRAIT_GENERIC)
...
/mob/living/carbon/human/species/kobold/base/skilled/medium_gear
	base_strength = 13
	base_speed = 11
	base_perception = 10
...
/mob/living/carbon/human/species/kobold/base/skilled/medium_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_MEDIUMARMOR, TRAIT_GENERIC)
	adjust_skillrank(/datum/skill/combat/swords, 3, TRUE)
	adjust_skillrank(/datum/skill/combat/axesmaces,3, TRUE)
...
/mob/living/carbon/human/species/kobold/base/very_skilled/medium_gear
	base_strength = 15
	base_speed = 12
	base_perception = 11
...
/mob/living/carbon/human/species/kobold/base/very_skilled/medium_gear/after_creation()
	..()
...
/mob/living/carbon/human/species/kobold/base/unskilled/heavy_gear
	base_strength = 11
	base_speed = 8
	base_perception = 8
	base_constitution = 12
...
/mob/living/carbon/human/species/kobold/base/unskilled/heavy_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_HEAVYARMOR, TRAIT_GENERIC)
	adjust_skillrank(/datum/skill/combat/swords, pick(1,2), TRUE)
	adjust_skillrank(/datum/skill/combat/axesmaces,pick(1,2), TRUE)
...
/mob/living/carbon/human/species/kobold/base/skilled/heavy_gear
	base_strength = 13
	base_speed = 9
	base_perception = 9
	base_constitution = 14
...
/mob/living/carbon/human/species/kobold/base/skilled/heavy_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_HEAVYARMOR, TRAIT_GENERIC)
	adjust_skillrank(/datum/skill/combat/swords, 3, TRUE)
	adjust_skillrank(/datum/skill/combat/axesmaces,3, TRUE)
...
/mob/living/carbon/human/species/kobold/base/very_skilled/heavy_gear
	base_strength = 15
	base_speed = 8
	base_perception = 11
...
/mob/living/carbon/human/species/kobold/base/very_skilled/heavy_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_NOPAINSTUN, TRAIT_GENERIC)
	ADD_TRAIT(src, TRAIT_HEAVYARMOR, TRAIT_GENERIC)
	adjust_skillrank(/datum/skill/combat/swords, 5, TRUE)
