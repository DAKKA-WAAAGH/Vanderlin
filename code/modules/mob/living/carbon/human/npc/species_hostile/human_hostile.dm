...
/mob/living/carbon/human/species/human/northern/base/very_skilled/after_creation()
	..()
...
/mob/living/carbon/human/species/human/northern/base/unskilled/after_creation()
	..()
...
/mob/living/carbon/human/species/human/northern/base/unskilled/naked/after_creation()
	..()
...
/mob/living/carbon/human/species/human/northern/base/skilled/naked/after_creation()
	..()
...
/mob/living/carbon/human/species/human/northern/base/very_skilled/naked/after_creation()
	..()
...
/mob/living/carbon/human/species/human/northern/base/unskilled/light_gear/after_creation()
	..()
...
/mob/living/carbon/human/species/human/northern/base/skilled/light_gear/after_creation()
	..()
...
/mob/living/carbon/human/species/human/northern/base/very_skilled/light_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_DUALWIELDER, TRAIT_GENERIC)
	ADD_TRAIT(src, TRAIT_DODGEEXPERT, TRAIT_GENERIC)
	ADD_TRAIT(src, TRAIT_LIGHT_STEP, TRAIT_GENERIC)
...
/mob/living/carbon/human/species/human/northern/base/unskilled/medium_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_MEDIUMARMOR, TRAIT_GENERIC)
...
/mob/living/carbon/human/species/human/northern/base/skilled/medium_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_MEDIUMARMOR, TRAIT_GENERIC)
	adjust_skillrank(/datum/skill/combat/swords, 3, TRUE)
	adjust_skillrank(/datum/skill/combat/axesmaces,3, TRUE)
...
/mob/living/carbon/human/species/human/northern/base/very_skilled/medium_gear/after_creation()
	..()
...
/mob/living/carbon/human/species/human/northern/base/unskilled/heavy_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_HEAVYARMOR, TRAIT_GENERIC)
	adjust_skillrank(/datum/skill/combat/swords, pick(1,2), TRUE)
	adjust_skillrank(/datum/skill/combat/axesmaces,pick(1,2), TRUE)
...
/mob/living/carbon/human/species/human/northern/base/skilled/heavy_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_HEAVYARMOR, TRAIT_GENERIC)
	adjust_skillrank(/datum/skill/combat/swords, 3, TRUE)
	adjust_skillrank(/datum/skill/combat/axesmaces,3, TRUE)
...
/mob/living/carbon/human/species/human/northern/base/very_skilled/heavy_gear/after_creation()
	..()
	ADD_TRAIT(src, TRAIT_NOPAINSTUN, TRAIT_GENERIC)
	ADD_TRAIT(src, TRAIT_HEAVYARMOR, TRAIT_GENERIC)
	adjust_skillrank(/datum/skill/combat/swords, 5, TRUE)
