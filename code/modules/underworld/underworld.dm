...
/obj/structure/underworld/carriageman/attack_hand(mob/living/carbon/spirit/user)
	if(!user.paid)
		user << sound(pick('modular/kaizoku/sound/misc/carriage1.ogg', 'modular/kaizoku/sound/misc/carriage2.ogg', 'modular/kaizoku/sound/misc/carriage3.ogg', 'modular/kaizoku/sound/misc/carriage4.ogg'), 0, 0 ,0, 50)
...
/obj/structure/underworld/carriage/attack_hand(mob/living/carbon/spirit/user)
	if(user.paid)
		switch(alert("Are you ready to be judged?",,"Yes","No"))
			if("Yes")
				playsound(user, 'modular/kaizoku/sound/misc/deadbell.ogg', 50, TRUE, -2, ignore_walls = TRUE)
