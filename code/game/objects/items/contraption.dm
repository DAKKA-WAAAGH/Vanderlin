...
/obj/item/contraption/wood_metalizer/attack_atom(atom/attacked_atom, mob/living/user)
	...
	user.adjust_experience(/datum/skill/craft/engineering, (user.STAINT / 2)) // STONEKEEP EDIT
...
/obj/item/contraption/smelter/attack_atom(atom/attacked_atom, mob/living/user)
	...
	if(!O.smeltresult)
		...
		S.start()
		return
	user.adjust_experience(/datum/skill/craft/engineering, (user.STAINT / 3)) // STONEKEEP EDIT
