...
/client/verb/reportissue()
	...
	//SEND_SOUND(src, 'modular/kaizoku/sound/misc/compiler-stage1.ogg')
	...
	if(issue_response.errored || issue_response.status_code != 201)
		//SEND_SOUND(src, 'modular/kaizoku/sound/misc/compiler-failure.ogg')
		...
		return
	//SEND_SOUND(src, 'modular/kaizoku/sound/misc/compiler-stage2.ogg')
