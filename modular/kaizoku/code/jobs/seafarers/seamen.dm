/datum/job/kaizoku/seamen
	...
	you were romantic idealists, but as each voyage passes with a storm, it only hardens your heart."
	department_flag = FACTION_IMPERIAL
	display_order = KZ_SEAMEN
	...
	outfit = /datum/outfit/kaizoku/seamen
	give_bank_account = TRUE
	cmode_music = 'sound/blank.ogg'

/datum/outfit/kaizoku/seamen/pre_equip(mob/living/carbon/human/H) //Not yet done.
	..()
