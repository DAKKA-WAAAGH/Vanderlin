/datum/job/kaizoku/cutthroat
	title = "Cutthroat"
	tutorial = "The muscles of the criminal syndicate, feared by the common \
	people ever since the days the outskirts were not patrolled. Things have \
	changed, and now, you are the street enforcer of the Panderer, collecting \
	debts, beating who fucks with your turf, protecting the massagers from aggressive \
	clients and guarding the den. Your loyalty is paramount, and failure will \
	cost your fingers, if not your life."
	department_flag = FACTION_MALEFACTORS
	job_flags = (JOB_ANNOUNCE_ARRIVAL | JOB_SHOW_IN_CREDITS | JOB_EQUIP_RANK | JOB_NEW_PLAYER_JOINABLE)
	display_order = KZ_CUTTHROAT
...
/datum/outfit/kaizoku/cutthroat // Base outfit for cutthroat, before loadouts
	name = "cutthroat"
...
// Brutal goon, a class balanced to town guard, with noticeably more strength but less intelligence and perception. Axe/Mace and shield focus.
/datum/job/advclass/kaizoku/cutthroat/gangster
	title = "Gokudo Goon"
	tutorial = "As a Gokudo, or 'The Extreme Path', your life was always \
	outside of the bounds of law ever since you've embraced violence as \
	a way to deal with your problems. Strong as retainers with none of the training, \
	you specialize in usage of maces and shields, albeit you have \
	little use for your brain."
...
/datum/job/advclass/kaizoku/cutthroat/tekiya
	title = "Tekiya"
	tutorial = "You've been an street peddler all your life, dealing in contraband, \
	protection rackets and scams, and this provided you plenty of opportunities to \
	steal and poison your competitors. Under the panderer, you've specialized in \
	using axes and crossbows for your street cunning."
...
/datum/job/advclass/kaizoku/cutthroat/kabukimono
	title = "Kabukimono"
	tutorial = "Dressing flamboyantly and carrying oversized blades, you've been \
	intimidating commoners and flaunting your defiance and swordplay every new moon. \
	You are eccentric and dangerous, but all of that makes part of the spectacle. \
	You are good in duels similarly to an trained Zamurai."
