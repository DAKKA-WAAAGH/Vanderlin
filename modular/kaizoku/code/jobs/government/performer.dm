/datum/job/kaizoku/performer
	title = "Performer"
	tutorial = "Placeholder"
	department_flag = FACTION_GOVERNMENT
	display_order = KZ_PERFORMER
	...
	outfit = /datum/outfit/kaizoku/performer
	spells = list(
		/datum/action/cooldown/spell/undirected/joke,
		/datum/action/cooldown/spell/undirected/tragedy,
		// /datum/action/cooldown/spell/undirected/fart, // God, no.
		/datum/action/cooldown/spell/vicious_mockery,
	)
	give_bank_account = TRUE

/datum/outfit/kaizoku/performer/pre_equip(mob/living/carbon/human/H)
	..()
