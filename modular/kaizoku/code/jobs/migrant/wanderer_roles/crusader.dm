/datum/job/advclass/pilgrim/rare/crusader
	...
	You were sent to Fog Islands by the Order to kill any sunscorned and their allies on this place filled of inhumens."
	allowed_races = RACES_NOTNATIVE_NONHERETICAL
